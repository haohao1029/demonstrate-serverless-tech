...
### Producer 
Producer have a `/process` POST API to publish message into RabbitMQ

### Consumer 
Consumer subscribed to rabbitmq channel, preprocess it and append it into csv file. The delimiter 
